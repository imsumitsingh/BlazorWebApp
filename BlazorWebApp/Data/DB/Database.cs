...
namespace BlazorWebApp.Data.DB
{
    public static class Database
    {
        ...
        public static void SetConnection(string ConnectionStringName)
        {
        ...
        public static bool IsExists(string TableName, string WhereColumn, string WhereValue)
        {
            ...
            try
            {
                ...
                sql = Database.GetScalerString(sql);
                if (sql != "")
                {
                    f = true;
                }
        ...
        {
            DataTable dt = Database.GetData("select * from " + tablename);
            return dt;
        }

        public static bool IsEmpty(string tablename)
        {
            if (Database.GetScalerInt("select count(*) from " + tablename) < 1)
            {
                return true;
            }
            return false;
